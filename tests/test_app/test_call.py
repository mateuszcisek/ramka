...
def test_app_call_with_static_files_engine():
    ...
    And the `_wsgi_app` method is not called.
    """
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        app._wsgi_app.assert_not_called()
...
def test_app_call_without_static_files_engine():
    ...
    And the app is called
    Then the `_wsgi_app` method is called
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        app._wsgi_app.assert_called_once_with(environ_mock, start_response_mock)
